...
describe("MenuItemReviewForm tests", () => {
    ...
    test("renders correctly when passing in a MenuItemReview", async () => {
        ...
        expect(screen.getByTestId("MenuItemReviewForm-reviewerEmail")).toHaveValue("student@ucsb.edu");
        expect(screen.getByTestId("MenuItemReviewForm-stars")).toHaveValue(4);
        expect(screen.getByTestId("MenuItemReviewForm-dateReviewed")).toHaveValue("2022-05-05T12:00");
        expect(screen.getByTestId("MenuItemReviewForm-comments")).toHaveValue("Pretty good");
    });
    ...
    test("Correct error messages on bad input", async () => {
        ...
        const emailField = await screen.findByTestId("MenuItemReviewForm-reviewerEmail");
