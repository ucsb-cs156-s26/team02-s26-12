...
describe("UCSBOrganizationEditPage tests", () => {
  ...
  describe("tests where backend is working normally", () => {
    ...
    test("Changes when you click Update", async () => {
      ...
      fireEvent.change(orgTranslationField, { target: { value: "ZETA FRAT" } });

      // Update the dropdown to "true"
      fireEvent.change(inactiveField, { target: { value: "true" } });

      fireEvent.click(submitButton);

      await waitFor(() => expect(mockToast).toBeCalled());
      expect(mockToast).toBeCalledWith("Organization Updated - orgCode: ZPR");
      ...
      expect(axiosMock.history.put[0].data).toBe(
        JSON.stringify({
          ...
          orgTranslationShort: "ZETA",
          orgTranslation: "ZETA FRAT",
          inactive: "true", // Expecting the string format
        }),
      ); // posted object
    });
  });
